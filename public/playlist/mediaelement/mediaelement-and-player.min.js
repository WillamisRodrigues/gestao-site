            ...
            if (!f.created) {
                ...
                !(g.isAndroid && f.options.AndroidUseNativeControls || g.isiPad && f.options.iPadUseNativeControls || g.isiPhone && f.options.iPhoneUseNativeControls)) {
                    ...
                    f.container.bind("mouseenter", function() {
                        ...
                        f.options.alwaysShowControls || f.startControlsTimer(f.options.controlsTimeoutMouseEnter))
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildprogress: function(b, c, d, e) {
            ...
            var m = function(a) {
              ...
              , n = function(a) {
                var c = e.currentTime
                  , d = mejs.i18n.t("mejs.time-slider")
                  , g = mejs.Utility.secondsToTimeCode(c, b.options)
                  , h = e.duration;
                f.slider.attr({
                    "aria-label": d,
                    "aria-valuemin": 0,
        ...
        buildfullscreen: function(b, c, d, e) {
            if (b.isVideo) {
                ...
                var f = this
                  ...
                  , i = a('<div class="mejs-button mejs-fullscreen-button"><button type="button" aria-controls="' + f.id + '" title="' + h + '" aria-label="' + h + '"></button></div>').appendTo(c).on("click", function() {
            ...
            b.isInIframe && setTimeout(function d() {
                if (b.isNativeFullScreen) {
                    var c = .002
                      ...
                      , g = Math.abs(f - e)
                      , h = f * c;
                    g > h ? b.exitFullScreen() : setTimeout(d, 500)
                }
    ...
    a.extend(MediaElementPlayer.prototype, {
        ...
        buildtracks: function(b, c, d, e) {
            if (0 !== b.tracks.length) {
                ...
                b.captionsButton = a('<div class="mejs-button mejs-captions-button"><button type="button" aria-controls="' + h.id + '" title="' + j + '" aria-label="' + j + '"></button><div class="mejs-captions-selector"><ul><li><input type="radio" name="' + b.id + '_captions" id="' + b.id + '_captions_none" value="none" checked="checked" /><label for="' + b.id + '_captions_none">' + mejs.i18n.t("mejs.none") + "</label></li></ul></div></div>").appendTo(c);
                var k = 0;
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        ...
        addSourceButton: function(b, c, d, e) {
            ...
            ("" === c || void 0 == c) && (c = b),
            d = d.split("/")[1],
            f.sourcechooserButton.find("ul").append(a('<li><input type="radio" name="' + f.id + '_sourcechooser" id="' + f.id + "_sourcechooser_" + c + d + '" role="menuitemradio" value="' + b + '" ' + (e ? 'checked="checked"' : "") + 'aria-selected="' + e + '" /><label for="' + f.id + "_sourcechooser_" + c + d + '" aria-hidden="true">' + c + " (" + d + ")</label></li>")),
