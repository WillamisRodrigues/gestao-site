<div id="n">
    ...
    <table class="table">
        ...
        <tbody>
        <tr>
            <th class="table-active" scope="col">Amazonas (3)</th>
        </tr>
          <tr>
            <td><i class="fa fa-map-marker" aria-hidden="true"></i> Autazes</td>
          </tr>
          <tr>
            <td><i class="fa fa-map-marker" aria-hidden="true"></i> Iranduba</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><i class="fa fa-map-marker" aria-hidden="true"></i> Xambioá</td>
          </tr>
          <tr>
            <th  class="table-active" scope="col">Rondônia (1)</th>
          </tr>
          <tr>
            <td><i class="fa fa-map-marker" aria-hidden="true"></i> Buritis</td>
          </tr>
        </tbody>
      </table>
</div>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <tr>
              ...
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Cachoeira </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Cairu </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Candeias </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Catu </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Governador Mangabeira</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Ilhéus</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Itajuípe</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> São Felix</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Barreira </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Baturité </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Boa Viagem </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Capistrano </td>
              </tr>
              <tr>
              ...
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Massapê</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Morrinhos</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Mucambo</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Pacujá</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Palhano </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Palmácia </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Paracuru</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Redenção</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Gravatá </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Igarassu</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Moreno </td>
              </tr>
              <tr>
                <td> <i class="fa fa-map-marker" aria-hidden="true"></i> Ouricuri </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Paulista</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Petrolina</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> São José da Coroa Grande</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Surubim</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Tacaimbó </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Taquaritinga do Norte </td>
              </tr>
              <tr>
              ...
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Trindade</td>
              </tr>
             
              <tr>
                <th  class="table-active" scope="col">Piauí (5)</th>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Betânia do Piauí</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Curral Novo do Piauí</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Demerval Lobão</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Nazária</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Nossa Senhora do Socorro</td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> São Cristóvão</td>
              </tr>
...
<div id="se">
    ...
    <table class="table">
        ...
        <tbody>
          ...
          <tr>
            <td><i class="fa fa-map-marker" aria-hidden="true"></i> Cantagalo</td>
          </tr>
          <tr>
...
<div id="co">
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <th  class="table-active" scope="col">Goiânia (5)</th>
            </tr>
          <tr>
            <td><i class="fa fa-map-marker" aria-hidden="true"></i> Barro Alto</td>
          </tr>
          <tr>
            <td><i class="fa fa-map-marker" aria-hidden="true"></i> Edealina</td>
          </tr>
          <tr>
            <td><i class="fa fa-map-marker" aria-hidden="true"></i> Goianésia</td>
          </tr>
          <tr>
            <td><i class="fa fa-map-marker" aria-hidden="true"></i> Niquelândia</td>
          </tr>
          <tr>
...
<div id="s">
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <th  class="table-active" scope="col">Paraná (3)</th>
            </tr>
            <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Almirante Tamandaré </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Itaperuçu </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Rio Branco do Sul</td>
              </tr>
              <tr>
                <th  class="table-active" scope="col">Santa Catarina (3)</th>
            </tr>
            <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Chapecó </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Imbituba </td>
              </tr>
              <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Vidal Ramos</td>
              </tr>
              <tr>
                <th  class="table-active" scope="col">Rio Grande do Sul (1)</th>
            </tr>
            <tr>
                <td><i class="fa fa-map-marker" aria-hidden="true"></i> Bento Gonçalves </td>
              </tr>
        </tbody>
      </table>
</div>
